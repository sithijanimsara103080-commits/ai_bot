...
const appCss = "/assets/styles-CsRU5P3F.css";
...
function AuthProvider({ children }) {
  ...
  const [isGuest, setIsGuestState] = reactExports.useState(false);
  reactExports.useEffect(() => {
...
const $$splitComponentImporter$7 = () => import("./start-CZYOxGp8.js");
const Route$7 = createFileRoute("/start")({
  head: () => ({
    meta: [{
      title: "System Boot — Mission Astro AI"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./onboarding-BxsttV0R.js");
const Route$6 = createFileRoute("/onboarding")({
  head: () => ({
    meta: [{
      title: "Get started — Mission Astro AI"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./login-B9-LgIfN.js");
const Route$5 = createFileRoute("/login")({
  head: () => ({
    meta: [{
      title: "Sign in — Mission Astro AI"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./developers-DwLIr1Ei.js");
const Route$4 = createFileRoute("/developers")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Meet the team behind Mission Astro AI."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./chat-DbVxByxx.js");
const Route$3 = createFileRoute("/chat")({
  head: () => ({
    meta: [{
      title: "Mission Control — Mission Astro AI"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./adminchat-BNmeIb11.js");
const Route$2 = createFileRoute("/adminchat")({
  head: () => ({
    meta: [{
      title: "Admin Console — Mission Astro AI"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./about-BJgStubf.js");
const Route$1 = createFileRoute("/about")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Learn about Mission Astro AI and the Radapasa Astronomical Society."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-D-gDdLVL.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Mission Astro AI is your advanced assistant for space science and research, powered by Radapasa Astronomical Society."
    }, {
      property: "og:title",
      content: "Mission Astro AI"
    }, {
      property: "og:description",
      content: "Your Advanced Assistant for Space Science & Research."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const StartRoute = Route$7.update({
  id: "/start",
  path: "/start",
...
const AdminchatRoute = Route$2.update({
  id: "/adminchat",
  path: "/adminchat",
  getParentRoute: () => Route$8
});
