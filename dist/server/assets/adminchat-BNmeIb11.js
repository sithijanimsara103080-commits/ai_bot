...
import { u as useAuth, L as Link } from "./router-CcUIL5VK.js";
import { B as Button } from "./button-Drn6kLDF.js";
import { X, d as Plus, T as Trash2, L as LogOut, P as PanelLeft, D as Dialog, a as DialogContent, c as Paperclip, I as Image, A as ArrowUp, b as FileText, F as File } from "./dialog-Boek4rJb.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-border bg-background/80 backdrop-blur-xl shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-3 sm:px-4 py-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card/80 backdrop-blur focus-within:border-primary focus-within:ring-1 focus-within:ring-primary/30 transition-all shadow-sm", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-2 pb-2 gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => onSend(input), disabled: !input.trim() && !selectedFile || sending, className: "h-8 w-8 shrink-0 rounded-lg bg-primary text-primary-foreground flex items-center justify-center hover:opacity-90 active:scale-95 transition-all disabled:opacity-40 disabled:cursor-not-allowed shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUp, { className: "h-4 w-4" }) })
      ] })
    ] }),
...
function AdminChatPage() {
  ...
  const [principalPopupOpen, setPrincipalPopupOpen] = reactExports.useState(true);
  reactExports.useEffect(() => {
  ...
  const send = reactExports.useCallback(async (text) => {
    ...
    try {
      const payload = {
        message: content || "",
        userId: "admin_principal_user",
        mode: mode.toLowerCase(),
        deviceId: "admin_principal_device"
      };
      if (fileSnap) {
  ...
  if (isGuestView) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-screen flex flex-col text-foreground", style: {
      ...
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx(MessageList, { msgs: active.messages, sending, isTyping: false, onComplete: () => {
      }, onScroll: () => {
        if (scrollRef.current) scrollRef.current.scrollTop = scrollRef.current.scrollHeight;
      } }) }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-screen flex text-foreground overflow-hidden", style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(LimitDialog, { open: showLimit, onClose: () => setShowLimit(false) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: principalPopupOpen, onOpenChange: setPrincipalPopupOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogContent, { className: "max-w-md mx-4 bg-card/95 backdrop-blur-xl border-white/20 rounded-2xl p-6 shadow-2xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-2 space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-16 w-16 mx-auto rounded-full bg-primary/20 flex items-center justify-center shadow-[0_0_20px_rgba(249,115,22,0.3)]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Crown, { className: "h-8 w-8 text-primary" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold tracking-tight text-white drop-shadow-md", children: "Welcome, Principal Mr. Kumara Piyathilaka!" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground leading-relaxed text-[15px]", children: [
        "Mission Astro AI is fully initialized and remotely connected to the Radapasa Astronomical Society core database.",
        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
        "We are at your service for space science exploration. 🌌🚀"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: () => setPrincipalPopupOpen(false), className: "w-full text-base font-semibold h-12 shadow-[0_0_15px_rgba(239,68,68,0.5)]", style: {
        background: "linear-gradient(135deg, #f97316, #ef4444)",
        color: "white"
      }, children: "Acknowledge & Access Dashboard" }) })
    ] }) }) })
  ] });
}
export {
